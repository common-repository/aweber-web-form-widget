...
== Grow your email list ==
1. Embed AWeber [landing pages](https://www.aweber.com/landing-page-builder.htm) and [sign up forms](https://www.aweber.com/sign-up-forms.htm) on your WordPress site.

2. Split-test sign up forms to grow your list faster.

3. Send contacts captured via [Elementor to AWeber](https://www.aweber.com/integrations/content-management/elementor/).
...
1. Use [web push notifications](https://www.aweber.com/web-push-notifications.htm) to send short messages straight to a subscriber's desktop with a link to your website.

2. Send [email marketing](https://www.aweber.com/email-marketing-features.htm) messages to promote your latest news, offers, or content.


== Monetize your content ==
1. Set up [ecommerce landing pages](https://www.aweber.com/aweber-for-ecommerce.htm) to accept monthly, quarterly, or annual subscription payments.
...
== Automate your emails ==
1. Set up an [email automation](https://www.aweber.com/email-automation.htm) to welcome new subscribers who sign up on your WordPress site.
...
4. Get started with an [email template](https://www.aweber.com/html-email-templates.htm) or [landing page template](https://www.aweber.com/templates/landing-pages/), then use the [drag-and-drop builder](https://www.aweber.com/drag-and-drop.htm) to customize it to match your brand.

5. [Integrate](https://www.aweber.com/integrations/) your emails with hundreds of online solutions.

6. [Automatically send newsletters](https://www.aweber.com/email-newsletters.htm) with your latest content published in WordPress or on YouTube.
...
== MORE ABOUT AWEBER ==
For over 20 years, AWeber has been a market leader helping over one million entrepreneurs, side hustlers, and businesses of all sizes grow with email marketing and other sales tools. [Get started with a free account](https://www.aweber.com/free.htm?utm_source=awpartnership&utm_medium=email&utm_campaign=product&utm_content=wordpress-integration).
...
== Upgrade Notice ==
= 5.0.0 =
* Update to quickly add existing AWeber landing pages to your WordPress website.

= 4.1.0 =
* Update to receive Elementor Pro support!

= 4.0.0 =
* Update to receive Elementor support!

= 3.1.0 =
* Update to the latest and greatest AWeber plugin!

= 3.0.0 =
* We've revamped the look and feel of the entire plugin

= 2.1.2 =
* Fixed an issue where subscribers were not being added when commenting.

= 2.0.0 =
Please update! We've moved to our own menu, added Sign Up Form & Split Testing stats, added the ability to include your AWeber analytics JavaScript file, and added a System Info page for troubleshooting.
